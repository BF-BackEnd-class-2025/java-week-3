# Week 3: Advanced OOP – Inheritance, Polymorphism & Interfaces
...
* Model simple domain data using immutable collections
* Complete a mini lab on `instanceof` pattern matching
